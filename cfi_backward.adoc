...
the privilege level where the program executes, the program continues to function
...
sequence and if multiple hart attempt to restore the checkpointed data, only one
of them succeeds.
====
