...
[listing]
# The a0 register holds the pointer to checkpoint at the top of the new shadow
# stack. x5 at end of the sequence has the address of the checkpoint created on
# current shadow stack. This should be saved away in a context structure to
# restore later.
switch_shadow_stack:
