...
The Zisslpcfi extension dedtermines if an indirect call or an indirect jump must
...
gaurded branches only where such threats are not applicable or are mitigated.
====
