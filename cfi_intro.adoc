...
[NOTE]
====
The definition of `Indirect Jump or Call` is needed to determine if the control flow 
is doing an indirect forward edge as they need to be protected:

.`Indirect Forward Edge` determination
[source, text]
----
